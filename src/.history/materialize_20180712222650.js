...
Vue.mixin({
    methods: {
        gramateria() {
            var seoTitle = (localStorage.getItem('seo_title'))?localStorage.getItem('seo_title'):"Gramateria Web Builder";
            var seoAuthor = (localStorage.getItem('seo_author'))?localStorage.getItem('seo_author'):"Gramateria";
            var seoDesc = (localStorage.getItem('seo_desc'))?localStorage.getItem('seo_desc'):"Gramateria - materialize design web builder.";
            var seoKey = (localStorage.getItem('seo_keywords'))?localStorage.getItem('seo_keywords'):"HTML5,CSS5,Generator,Web,Maker,Builder,Materialize,GrapeJS,Electron";
