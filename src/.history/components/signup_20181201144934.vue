<template>
    ...
    <Form ref="signUpForm" :model="signUpForm" :rules="signUpRules" >
        ...
        <FormItem prop="conPassword">
            <Input type="password" v-model="signUpForm.conPassword" placeholder="Comfirm Password">
            <Icon type="ios-locked-outline" slot="prepend"></Icon>
            </Input>
        </FormItem>
        ...
        data () {
            const confirmPass = (rule, value, callback) => {
                if (value === '') {
                    ...
                    if (this.signUpForm.password !== this.signUpForm.conPassword) {
